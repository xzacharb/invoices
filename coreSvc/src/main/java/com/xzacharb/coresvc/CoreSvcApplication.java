...
public class CoreSvcApplication {
    ...
    public CommandLineRunner sampleData(CoreDbService repository) {
        return (args) -> {
            ...
            ManagementPerson companyPersonDao1 = new ManagementPerson("Person name1", "Person middleName1", "person sureName1", "Person address1", "Person source1", new Date(), role1, contractor1, city1, managementType1);
            ManagementPerson companyPersonDao2 = new ManagementPerson("Person name2", "Person middleName2", "person sureName2", "Person address2", "Person source2", new Date(), role2, contractor1, city2, managementType1);
            ManagementPerson companyPersonDao3 = new ManagementPerson("Person name3", "", "person sureName3", "Person address2", "Person source3", new Date(), role3, contractor1, city2, managementType2);
            ManagementPerson companyPersonDao4 = new ManagementPerson("Person name4", "Person middleName3", "person sureName3", "Person address3", "Person source3", new Date(), role2, contractor3, city1, managementType2);
            ManagementPerson companyPersonDao5 = new ManagementPerson("Person name5", "", "person sureName4", "Person address31", "Person source31", new Date(), role2, contractor2, city1, managementType2);
            ManagementPerson companyPersonDao6 = new ManagementPerson("Person name6", "", "person sureName33", "Person address32", "Person source23", new Date(), role2, contractor3, city1, managementType2);
