...
export class InvoiceService {
  ...
  public findCompanyPersons(companyId: number): Observable<Person[]> {
    return this.http.get<Person[]>(
      this.inveicesBase + "company/people/" + companyId
    );
  }
  ...
  public findCityInvoices(
    ruleName: string,
    city: string,
    companyId: string
  ): Observable<Invoice[]> {
    return this.http.get<Invoice[]>(
      this.inveicesBase + city + "/" + ruleName + "/" + companyId
    );
  }
  public findCompanyInfo(
    ...
    return this.http.get<InfoData[]>(
      this.inveicesRules + city + "/" + ruleName
    );
  }
